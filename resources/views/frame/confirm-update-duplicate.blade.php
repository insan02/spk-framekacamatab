        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-circle"></i> <strong>Perhatian!</strong> Sistem mendeteksi perubahan frame yang akan disimpan memiliki kemiripan dengan frame yang sudah ada.
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Perubahan Frame (ID: {{ $frame->frame_id }})</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 text-center">
                                ...
                                @elseif($frame->frame_foto && Storage::disk('public')->exists($frame->frame_foto))
                                    <div class="d-flex justify-content-center align-items-center" style="height: 200px;">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-header bg-secondary text-white text-center">
                                            <h6 class="mb-0">ID: {{ $similarFrameItem->frame_id }} - {{ $similarFrameItem->frame_merek }}</h6>
                                        </div>
                                        <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    <h5>Apakah perubahan frame tetap akan dilanjutkan meskipun ada kesamaan?</h5>
            ...
            <div class="card-footer text-center">
                <a href="{{ route('frame.edit', $frame->frame_id) }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Kembali ke Form Edit Frame
                </a>
            </div>
        </div>
    </div>
