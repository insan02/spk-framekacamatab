...
class SubkriteriaController extends Controller
{
    ...
    public function update(Request $request, Subkriteria $subkriteria)
    {
        ...
        foreach ($data as $key => $value) {
            // Konversi nilai null dan string kosong untuk perbandingan yang konsisten
            $oldValue = $subkriteria->$key;
            if (is_null($oldValue)) $oldValue = null;
            if (is_null($value)) $value = null;
            
            // Konversi nilai numerik untuk perbandingan konsisten
        ...
        // Jika tidak ada perubahan, kembalikan dengan pesan informasi
        if (!$hasChanges) {
        ...
        try {
            ...
            // Catat aktivitas hanya jika ada perubahan
            ActivityLogService::log(
                'update',
                'subkriteria',
                $subkriteria->subkriteria_id,
